...
// not using router.use to protect middleware cause not all endpoint is admin related, so create product for this is purely
// admin creating product.

// all product admin here
router.post("/", authenticateToken, isAdmin, async (req, res) => {
  try {
    ...
    const [newProduct] = await pool.execute("SELECT * FROM products WHERE id = ?", [
      result.insertId,
    ]);
